...
def train_and_evaluate_patient(patient_name, gpu_id, seed, hyperparameters):
    ...
    in a closed-loop setting (no meal information).
    """
    ...
    # New agent name for the closed-loop experiment
    AGENT_NAME = 'sac_personalized_exp_closed_loop'
    ...
    # ---- MODIFIED: State dimension is now 3 [glucose, rate, iob] ----
    state_dim = 3
    action_dim = 1
    ...
    for i_episode in range(1, max_episodes + 1):
        ...
        # ---- MODIFIED: Removed upcoming_carbs logic ----
    ...
    plt.title(f'Learning Curve for {patient_name} (Closed-Loop)')
    plt.xlabel('Episode')
...
#     results_dir = f'./results/sac_personalized_exp_closed_loop'
#     os.makedirs(results_dir, exist_ok=True)
...
#     print("\n" + "="*50)
#     print(f"Starting parallel CLOSED-LOOP training for {len(tasks)} patients on {num_gpus} GPUs...")
#     print("="*50)
...
#         # --- Plot Overall Average Learning Curve ---
